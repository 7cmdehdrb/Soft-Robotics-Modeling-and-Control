...
Run:
    python cosserat_soft_robot_3ch_gui.py
...
def run_gui() -> None:
    ...
    points, _, last_guess, success, res_norm = solve_shape(params, pressures0, phase0, last_guess)
    ...
    def update(_=None) -> None:
        ...
        pts, _, last_guess, ok, rn = solve_shape(params, pressures, phase_rad, last_guess)
